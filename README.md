...
[![Linkedin](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/aleffmpc)
...
### 🧪 Pesquisa e Projetos Atuais
* **PIBITI (AI in Healthcare):** Pesquisa comparativa entre **CNNs** e **Visual Transformers (ViT)** com foco em **XAI (Explainable AI)** para detecção de nódulos pulmonares.
* **EvoSystem:** Ferramenta de otimização de sistemas e mitigação de vulnerabilidades em C#/.NET.
* **Cloud Architecture:** Desenvolvimento de microsserviços em **Go** com integração **AWS S3**.

---

### 📊 Estatísticas
![Aleff's GitHub stats](https://github-readme-stats.vercel.app/api?username=aleff5&show_icons=true&theme=tokyonight)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=aleff5&layout=donut&theme=tokyonight)
